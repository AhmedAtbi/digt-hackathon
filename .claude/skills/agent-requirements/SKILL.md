...
description: Run workflow stage "01-requirement-enrichment". Reads the canonical prompt from .agent/workflow/01-requirement-enrichment/prompt.md.
---

# agent-requirements

This skill drives workflow stage **`01-requirement-enrichment`**. The canonical instructions
live in the framework at `.agent/workflow/01-requirement-enrichment/prompt.md` — read that
first, then follow the steps.

When this skill is invoked:

1. Read `.agent/workflow/01-requirement-enrichment/prompt.md` end-to-end.
