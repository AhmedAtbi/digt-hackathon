...
description: Run workflow stage "13-deployment". Reads the canonical prompt from .agent/workflow/13-deployment/prompt.md.
---

# agent-deployment

This skill drives workflow stage **`13-deployment`**. The canonical instructions
live in the framework at `.agent/workflow/13-deployment/prompt.md` — read that
first, then follow the steps.

When this skill is invoked:

1. Read `.agent/workflow/13-deployment/prompt.md` end-to-end.
