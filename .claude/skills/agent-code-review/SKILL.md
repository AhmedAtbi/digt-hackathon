...
description: Run workflow stage "10-code-review". Reads the canonical prompt from .agent/workflow/10-code-review/prompt.md.
---

# agent-code-review

This skill drives workflow stage **`10-code-review`**. The canonical instructions
live in the framework at `.agent/workflow/10-code-review/prompt.md` — read that
first, then follow the steps.

When this skill is invoked:

1. Read `.agent/workflow/10-code-review/prompt.md` end-to-end.
