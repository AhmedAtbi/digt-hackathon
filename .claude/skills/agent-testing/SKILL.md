---
name: agent-testing
description: Run workflow stage "11-testing". Reads the canonical prompt from .agent/workflow/11-testing/prompt.md.
---

# agent-testing

This skill drives workflow stage **`11-testing`**. The canonical instructions
live in the framework at `.agent/workflow/11-testing/prompt.md` — read that
first, then follow the steps.

When this skill is invoked:

1. Read `.agent/workflow/11-testing/prompt.md` end-to-end.
