---
name: agent-prioritization
description: Run workflow stage "08-prioritization". Reads the canonical prompt from .agent/workflow/08-prioritization/prompt.md.
---

# agent-prioritization

This skill drives workflow stage **`08-prioritization`**. The canonical instructions
live in the framework at `.agent/workflow/08-prioritization/prompt.md` — read that
first, then follow the steps.

When this skill is invoked:

1. Read `.agent/workflow/08-prioritization/prompt.md` end-to-end.
