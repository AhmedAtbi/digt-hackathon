...
description: Run workflow stage "09-development". Reads the canonical prompt from .agent/workflow/09-development/prompt.md.
---

# agent-development

This skill drives workflow stage **`09-development`**. The canonical instructions
live in the framework at `.agent/workflow/09-development/prompt.md` — read that
first, then follow the steps.

When this skill is invoked:

1. Read `.agent/workflow/09-development/prompt.md` end-to-end.
